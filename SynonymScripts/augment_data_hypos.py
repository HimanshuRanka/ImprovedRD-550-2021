...
def main():
    ...
    for init_word in all_words:
        all_word_def_pairs = get_hyponyms(init_word)
        print(f'The word is: {init_word} -------------------- {len(all_word_def_pairs)}')
    ...
    json.dump(all_data, open(osp.join("..", "data", "data_hypo_exp.json"), "w"))
