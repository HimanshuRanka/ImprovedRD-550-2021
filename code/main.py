...
def main(frequency, batch_size, epoch_num, verbose, MODE, lc, directory):
    mode = MODE
    if lc: 
        Encoder = LCEncoder
    else: 
...
if __name__ == '__main__':
    ...
    parser.add_argument('-lc', '--learn_channel',default=False, action='store_true') # learning the channels
    parser.add_argument('-dr', '--save_dir', type=str, default='../runs/code/')

    args = parser.parse_args()
    setup_seed(args.seed)
    os.environ['CUDA_VISIBLE_DEVICES'] = args.gpu
    main(args.frequency, args.batch_size, args.epoch_num, args.verbose, args.mode, args.learn_channel, args.save_dir)