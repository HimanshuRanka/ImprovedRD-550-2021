...
def load_data(frequency):
    ...
    data_test_500_rand1_seen = json.load(open(os.path.join(data_path, 'data_test_500_rand1_seen.json'), encoding='utf-8'))
    data_test_500_rand1_unseen = json.load(open(os.path.join(data_path, 'data_test_500_rand1_unseen.json'), encoding='utf-8')) #data_test_500_others
